...
"""
This section of the code defines the configuration options for performing a Tweets by URLs using the Desearch client.

Attributes:
    urls (List[str]): The search query to be used in the Tweets by URLs.
"""

# Perform an Tweets by URLs using the Desearch client
